...
for i = (1:100)
    ...
    elseif co == "X"
        F0 = [Fic.F_1,Fic.F_2,Fic.F_3,Fic.F_4,Fic.F_5,Fic.F_6,Fic.F_7,Fic.F_8,Fic.F_9,Fic.F_10,Fic.F_11,0,Fic.F_13,Fic.F_14,Fic.F_15,Fic.F_16,Fic.F_17,Fic.F_18,Fic.F_19,Fic.F_20,Fic.F_21,Fic.F_22,p_100.Kms(i),p_100.Vms(i)*mulfac,p_100.krs(i)*mulfac,p_100.t(i)];% X
    elseif co == "A"
      ...
      [t,F_ako] = ode23s('TM_3_odes',tspan ,F0); % METHOD 1

      R_ = reaction_TM_3(F_ako,p_100.Kms(i),p_100.Vms(i)*mulfac,p_100.krs(i)*mulfac,mulfac);
